...
export default function RateSeller() {
  ...
  const alreadyRated = hasRated(offerId ?? '', 'buyer');
    ...
    return (
      <AppLayout>
        <div className="text-center py-16">
          ...
          <Link to="/buyer/orders" className="mt-4 inline-block text-brand-pink font-semibold">Meus pedidos</Link>
        </div>
      </AppLayout>
    );
  }
      ...
      <AppLayout>
        <div className="max-w-md mx-auto flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="text-2xl font-extrabold text-gray-900 mb-2">
            {submitted ? 'Avaliação enviada!' : 'Você já avaliou este vendedor'}
          </h2>
          <p className="text-gray-500 mb-6">
            {submitted ? `Obrigado por avaliar ${offer.sellerName}. Seu feedback ajuda outros compradores.` : 'Obrigado pelo seu feedback!'}
          </p>
          <Link to="/buyer/orders"
            ...
            Meus pedidos <ArrowRight size={16} />
          </Link>
        </div>
      </AppLayout>
    );
  ...
  const handleSubmit = () => {
    ...
    submitRating({
      ...
      raterId: user.id,
      raterName: user.name,
      rateeId: offer.sellerId,
      rateeName: offer.sellerName,
      raterRole: 'buyer',
      score,
      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white rounded-3xl border border-gray-100 shadow-sm p-8">
          ...
          <div className="flex flex-col items-center mb-6">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-brand-pink to-brand-blue flex items-center justify-center text-4xl font-bold text-white mb-3">
              {offer.sellerName.charAt(0)}
            </div>
            <h1 className="text-xl font-extrabold text-gray-900">Avalie {offer.sellerName}</h1>
            <p className="text-sm text-gray-500 mt-1 text-center">
              Como foi sua experiência com o vendedor em<br />
          ...
          <div className="mt-4">
            ...
            <textarea value={comment} onChange={e => setComment(e.target.value)}
              placeholder="Conte como foi a negociação, qualidade do produto, entrega..."
